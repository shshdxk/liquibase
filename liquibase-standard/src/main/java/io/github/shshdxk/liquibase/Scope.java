...
import io.github.shshdxk.liquibase.analytics.Event;
...
import io.github.shshdxk.liquibase.license.LicenseTrackList;
import io.github.shshdxk.liquibase.listener.LiquibaseListener;
...
import io.github.shshdxk.liquibase.logging.mdc.MdcManagerFactory;
import io.github.shshdxk.liquibase.logging.mdc.MdcObject;
import io.github.shshdxk.liquibase.osgi.ContainerChecker;
...
import io.github.shshdxk.liquibase.servicelocator.StandardServiceLocator;
...
import io.github.shshdxk.liquibase.util.CollectionUtil;
import io.github.shshdxk.liquibase.util.SmartMap;
...
public class Scope {
     ...
     * The value is converted to the given type if necessary using {@link ObjectUtil#convert(Object, Class)}.
