...
import io.github.shshdxk.liquibase.AbstractExtensibleObject;
...
public class ConsoleUIService extends AbstractExtensibleObject implements UIService {
    ...
    /**
     * Returns {@link Plugin#PRIORITY_NOT_APPLICABLE} because it must be manually configured as needed
     */
    @Override
