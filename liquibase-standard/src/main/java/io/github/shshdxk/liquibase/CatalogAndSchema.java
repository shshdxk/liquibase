...
/**
 * Object representing a database catalog and schema. This differs from {@link Schema} in that it has
...
public class CatalogAndSchema {
     ...
     *
     * @see CatalogAndSchema#customize(Database)
     * */
     ...
     *
     * @see CatalogAndSchema#standardize(Database)
     */
