...
import io.github.shshdxk.liquibase.ExtensibleObject;
...
import io.github.shshdxk.liquibase.exception.SetupException;
 ...
 * <p>
 * Instances of these objects are normally created via the {@link ChangeFactory} by {@link ChangeLogParser} implementations.
 *
 * @see ChangeFactory
 * @see Database
 */
public interface Change extends LiquibaseSerializable, Plugin, ExtensibleObject {
    ...
    */
     ...
     *
     * @param changeVisitor
     * @throws ParsedNodeException if there is an error processing ChangeVisitor
     */
