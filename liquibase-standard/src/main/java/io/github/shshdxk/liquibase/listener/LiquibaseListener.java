package io.github.shshdxk.liquibase.listener;

import io.github.shshdxk.liquibase.Scope;

/**
 * Base interface for all the different listeners available in liquibase.
 * There are no common methods defined, since each listener can be very different, but the common base class allows them all to be registered through {@link Scope#child(LiquibaseListener, Scope.ScopedRunner)}.
