...
import io.github.shshdxk.liquibase.io.EmptyLineAndCommentSkippingInputStream;
...
import io.github.shshdxk.liquibase.statement.core.InsertSetStatement;
...
import io.github.shshdxk.liquibase.util.csv.CSVReader;
                ...
                for (int i = 0; i < headers.length; i++) {
                    ...
                    if (columnConfig != null) {
                        ...
                        if (StringUtil.equalsWordNull(value)) {
                            ...
                            SequenceNextValueFunction function =
                                    new SequenceNextValueFunction(getSchemaName(), value);
                            valueConfig.setValueComputed(function);
