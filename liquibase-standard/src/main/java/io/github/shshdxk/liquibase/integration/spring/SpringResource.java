...
/**
 * {@link io.github.shshdxk.liquibase.resource.Resource} implementation around a {@link Resource}
 */
class SpringResource extends AbstractResource {
    ...
    @Override
    public io.github.shshdxk.liquibase.resource.Resource resolve(String other) {
        try {
    ...
    @Override
    public io.github.shshdxk.liquibase.resource.Resource resolveSibling(String other) {
        try {
            Resource otherResource = this.resource.createRelative(other);
