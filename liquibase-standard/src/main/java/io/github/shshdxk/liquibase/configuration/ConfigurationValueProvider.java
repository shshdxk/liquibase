...
import io.github.shshdxk.liquibase.configuration.core.ScopeValueProvider;
import io.github.shshdxk.liquibase.configuration.core.SystemPropertyValueProvider;
...
public interface ConfigurationValueProvider {
     ...
     * <ul>
     *     <li>400 {@link ScopeValueProvider}</li>
     *     <li>350 {@link DeprecatedConfigurationValueProvider}</li>
     *     <li>250 Integration specific providers</li>
     *     <li>300: TODO JNDI attributes</li>
     *     <li>250: TODO Servlet Context</li>
     *     <li>200 {@link SystemPropertyValueProvider}</li>
