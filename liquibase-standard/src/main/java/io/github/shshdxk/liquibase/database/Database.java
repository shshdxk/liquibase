...
public interface Database extends PrioritizedService, AutoCloseable {
     ...
     * @deprecated please call {@link Database#supports(Class)} with the {@link Sequence} type instead
     */
    @Deprecated
     ...
     *
     * @deprecated Use {@link ChangeLogHistoryService#tag(String)} instead
     */
    @Deprecated
    void tag(String tagString) throws DatabaseException;

    /**
     * @deprecated Use {@link ChangeLogHistoryService#tagExists(String)} instead
     */
    @Deprecated
     ...
     * @deprecated please call {@link Database#supports(Class)} with the {@link Catalog} type instead
     */
    @Deprecated
     ...
     * @deprecated please call {@link Database#supports(Class)} with the {@link Schema} type instead
     */
    @Deprecated
     ...
     * @deprecated use {@link CatalogAndSchema#standardize(Database)}
     */
    @Deprecated
