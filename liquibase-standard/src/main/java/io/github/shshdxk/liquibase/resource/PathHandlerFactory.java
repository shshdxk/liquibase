...
public class PathHandlerFactory extends AbstractPluginFactory<PathHandler> {
     ...
     * @throws IOException if the path exists as both a direct resourcePath and also in the resourceAccessor (if included). Unless {@link GlobalConfiguration#DUPLICATE_FILE_MODE} overrides that behavior.
     */
