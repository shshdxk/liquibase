 ...
 *
 * If creating an ExtensibleObject, it is usually best to extend {@link AbstractExtensibleObject} rather than this interface directly.
...
public interface ExtensibleObject extends Cloneable {
     ...
     * Conversion is done using {@link ObjectUtil#convert(Object, Class)}.
