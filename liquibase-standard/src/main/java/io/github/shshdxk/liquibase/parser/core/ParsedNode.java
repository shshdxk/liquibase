package io.github.shshdxk.liquibase.parser.core;
 ...
 * {@link ChangeLogParser} implementations and other classes that work with multiple formats can create objects
 ...
 * For example, {@link Change#load(ParsedNode, ResourceAccessor)}.
 * <p/>
...
public class ParsedNode {
     ...
     * @throws ParsedNodeException if multiple nodes match.
     */
     ...
     * @throws ParsedNodeException if there is an error converting the value
     */
