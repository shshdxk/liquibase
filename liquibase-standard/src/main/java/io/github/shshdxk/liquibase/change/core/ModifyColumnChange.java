...
import io.github.shshdxk.liquibase.statement.ColumnConstraint;
import io.github.shshdxk.liquibase.statement.NotNullConstraint;
import io.github.shshdxk.liquibase.statement.SqlStatement;
import io.github.shshdxk.liquibase.statement.core.ModifyColumnStatement;
    ...
    public SqlStatement[] generateStatements(Database database) {
        ...
        if (getColumns().isEmpty()) {
            return new SqlStatement[]{
                    new ModifyColumnStatement(catalogName, schemaName, tableName, null, null, null)
            };
        }
