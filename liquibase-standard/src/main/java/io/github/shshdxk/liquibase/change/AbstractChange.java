...
import io.github.shshdxk.liquibase.change.visitor.ChangeVisitor;
...
import io.github.shshdxk.liquibase.plugin.AbstractPlugin;
...
import static io.github.shshdxk.liquibase.statement.SqlStatement.EMPTY_SQL_STATEMENT;
 ...
 * and delegating logic to the {@link SqlGenerator} objects created to do the actual change work.
...
public abstract class AbstractChange extends AbstractPlugin implements Change {
     ...
     * {@link LiquibaseSerializable.SerializationType#NAMED_FIELD} as a default.
     */
    @SuppressWarnings("UnusedParameters")
    protected LiquibaseSerializable.SerializationType createSerializationTypeMetaData(
     ...
     * {@link SqlGenerator#generateStatementsIsVolatile(Database) } method on the
    ...
    /**
     * Implementation delegates logic to the
     * {@link SqlGenerator#generateRollbackStatementsIsVolatile(Database) }
    ...
    /**
     * Implementation delegates logic to the
     * {@link SqlGenerator#supports(SqlStatement, Database)}
     * method on the {@link SqlStatement} objects returned by {@link #generateStatements}.
    ...
    /**
     * Implementation delegates logic to the
     * {@link SqlGenerator#warn(SqlStatement, Database,
     * SqlGeneratorChain)} method on the {@link SqlStatement} objects returned by
     ...
     * {@link SqlGenerator#validate(SqlStatement,
     * Database, SqlGeneratorChain)}  method on the {@link SqlStatement}
     ...
     * returns null.
     * <p/>
     * If {@link #generateRollbackStatements(Database)} is overridden, this method may not be called.
     *
    ...
    /**
     * Implementation delegates logic to the
     * {@link SqlGeneratorFactory#getAffectedDatabaseObjects(SqlStatement,
     * Database)} method on the {@link SqlStatement} objects returned by {@link #generateStatements}
