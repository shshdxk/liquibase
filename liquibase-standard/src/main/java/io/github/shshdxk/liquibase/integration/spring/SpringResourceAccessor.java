package io.github.shshdxk.liquibase.integration.spring;
...
public class SpringResourceAccessor extends AbstractResourceAccessor {
    ...
    @Override
    public List<io.github.shshdxk.liquibase.resource.Resource> getAll(String path) throws IOException {
        ...
        List<io.github.shshdxk.liquibase.resource.Resource> returnList = new ArrayList<>();
    ...
    @Override
    public List<io.github.shshdxk.liquibase.resource.Resource> search(String searchPath, boolean recursive) throws IOException {
        if (recursive) {
            searchPath += "/**";
        } else {
            searchPath += "/*";
