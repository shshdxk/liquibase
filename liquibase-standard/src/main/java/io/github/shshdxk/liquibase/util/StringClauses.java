...
public class StringClauses {
    ...
    /**
     * Convenience method for {@link #prepend(String, StringClauses)} when using enums
     */
    ...
    /**
     * Convenience method for {@link #replace(String, StringClauses)} when using enums.
     */
    ...
    public String toString() {
        ...
        finalList.removeIf(next -> StringUtils.isEmpty(next.toString()));
    ...
    public boolean isEmpty() {
        ...
        for (Object clause : clauses.values()) {
            if (!StringUtils.trimToEmpty(clause.toString()).isEmpty()) {
                return false;
            }
        }
        return true;
