...
public class MockDatabase implements Database, InternalDatabase {
    ...
    /**
     * @see Database#getDatabaseChangeLogTableName()
     */
    @Override
     ...
     * Does nothing
     *
     * @see Database#setDatabaseChangeLogTableName(java.lang.String)
     */
    @Override
    ...
    /**
     * @see Database#getDatabaseChangeLogLockTableName()
     */
    @Override
     ...
     * Does nothing
     *
     * @see Database#setDatabaseChangeLogLockTableName(java.lang.String)
     */
    @Override
