...
public class ChangeParameterMetaData {
     ...
     * returned by {@link Database#getShortName()}.
    ...
    /**
     * Returns a dot-delimited chain of {@link DatabaseObject} fields describing what existing
     ...
     * <p></p>
     * The values of the chain correspond to the {@link DatabaseObject#getObjectTypeName()} and
     * {@link DatabaseObject#getAttributes()}
     * <p></p>
    ...
    /**
     * Return the {@link LiquibaseSerializable.SerializationType}
