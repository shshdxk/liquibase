...
public class ChangesetsRolledback implements CustomMdcObject {
    ...
    /**
     * Generate a {@link ChangesetsRolledback} object from a list of {@link io.github.shshdxk.liquibase.changelog.ChangeSet}s.
     */
    public static ChangesetsRolledback fromChangesetList(List<io.github.shshdxk.liquibase.changelog.ChangeSet> changeSets) {
        if (changeSets != null) {
    ...
    public static class ChangeSet {
        ...
        public static ChangeSet fromChangeSet(io.github.shshdxk.liquibase.changelog.ChangeSet changeSet) {
