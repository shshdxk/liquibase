...
import io.github.shshdxk.liquibase.serializer.ReflectionSerializer;
...
public class ColumnConfig extends AbstractLiquibaseSerializable {
     ...
     * This value will pass through {@link DataTypeFactory#fromDescription(String, Database)} before being included in SQL.
     */
